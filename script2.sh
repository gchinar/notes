...
and then tells you whether:
	•	federated provider differs
	•	aud differs
	•	sub differs

If you want, I can also give you a version that takes role names directly from AWS CLI instead of JSON files.
